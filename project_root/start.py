...
from app.api.db.db import async_engine, session_manager as manager, SessionManager
from app.api.router.router import api_router
from app.api.services import user, api_key, follower, tweet
...
async def lifespan(*_: FastAPI):
    ...
    async with manager.get_session() as session:
        for user_obj in users:
            ...
            await tweet.save_user_tweets_with_likes_and_media(list_tweets_flush, user_flush, media, session)
